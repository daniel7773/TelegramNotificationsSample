...
public class NotificationCenter {
    ...
    public static final java.lang.String LOG_TAG = "NotificationCenter";

    private static int totalEvents = 1;

    public static final int event1 = totalEvents++;
    public static final int event2 = totalEvents++;
    public static final int event3 = totalEvents++;
    ...
    public void postNotificationNameInternal(int id, boolean allowDuringAnimation, Object... args) {
        if (MyHelper.isDebug()) {
            if (Thread.currentThread() != MyHelper.getMainHandler().getLooper().getThread()) {
                throw new RuntimeException("post allowed only from MAIN thread");
            }
        }
        if (!allowDuringAnimation && animationInProgress) {
            ...
            if (MyHelper.isDebug()) {
                Log.e(LOG_TAG, "delay post notification " + id + " with args count = " + args.length);
            }
            return;
        }
        broadcasting++;
